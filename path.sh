...
export KALDI_ROOT="/home/user1/kaldi" #change this when we transfer to server
...
export DATA_ROOT="/home/user2/Aditya/digits_IIIT" #change this as well, although we are not using it as far as I know
# Enable SRILM
